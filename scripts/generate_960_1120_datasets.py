#!/usr/bin/env python3
"""
generate_960_1120_datasets.py
==============================

Generate datasets for 960K and 1120K samples to test if performance continues improving.
"""
...
def main():
    print("="*80)
    print("GENERATE DATASETS FOR 960K AND 1120K")
    print("="*80)
    print("\nThis script will:")
