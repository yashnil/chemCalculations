#!/usr/bin/env python3
"""
train_1760_2080_models.py
=========================

Train models for 1760K and 2080K dataset sizes using the optimal architecture.
"""
...
def main():
    print("="*80)
    print("TRAINING MODELS FOR 1760K AND 2080K")
    print("="*80)
    ...
    if missing:
        ...
        print("   python scripts/generate_1760_2080_datasets.py")
        return
