#!/usr/bin/env python3
"""
generate_2400_2720_3040_datasets.py
===================================

Generate datasets for 2400K, 2720K, and 3040K samples to continue the constant increment study.
"""
...
def main():
    print("="*80)
    print("GENERATE DATASETS FOR 2400K, 2720K, AND 3040K")
    print("="*80)
    print("\nThis script will:")
