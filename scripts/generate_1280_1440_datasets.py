#!/usr/bin/env python3
"""
generate_1280_1440_datasets.py
===============================

Generate datasets for 1280K and 1440K samples to test if performance continues improving.
"""
...
def main():
    print("="*80)
    print("GENERATE DATASETS FOR 1280K AND 1440K")
    print("="*80)
    print("\nThis script will:")
