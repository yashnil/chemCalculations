#!/usr/bin/env python3
"""
train_1280_1440_models.py
=========================

Train models for 1280K and 1440K dataset sizes using the optimal architecture.
"""
...
def main():
    print("="*80)
    print("TRAINING MODELS FOR 1280K AND 1440K")
    print("="*80)
    ...
    if missing:
        ...
        print("   python scripts/generate_1280_1440_datasets.py")
        return
