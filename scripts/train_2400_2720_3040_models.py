#!/usr/bin/env python3
"""
train_2400_2720_3040_models.py
==============================

Train models for 2400K, 2720K, and 3040K dataset sizes using the optimal architecture.
"""
...
def main():
    print("="*80)
    print("TRAINING MODELS FOR 2400K, 2720K, AND 3040K")
    print("="*80)
    ...
    if missing:
        ...
        print("   python scripts/generate_2400_2720_3040_datasets.py")
        return
    ...
    print("\n⚠️  Each model takes ~40-50 minutes (200 epochs)")
    print(f"   Total estimated time: ~{len(configs_created) * 45} minutes ({len(configs_created) * 45 / 60:.1f} hours)")
    ...
    print("="*80)
    print("\nNext steps:")
    print("1. Update comparison metrics: python scripts/update_plots_for_optimal_retrained.py")
