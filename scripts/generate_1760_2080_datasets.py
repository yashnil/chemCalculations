#!/usr/bin/env python3
"""
generate_1760_2080_datasets.py
===============================

Generate datasets for 1760K and 2080K samples to test if performance continues improving.
"""
...
def main():
    print("="*80)
    print("GENERATE DATASETS FOR 1760K AND 2080K")
    print("="*80)
    print("\nThis script will:")
