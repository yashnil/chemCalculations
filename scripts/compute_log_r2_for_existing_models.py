#!/usr/bin/env python3
"""
compute_log_r2_for_existing_models.py
======================================

Compute log_r2 for existing optimal_retrained models by re-evaluating on test set.
This updates summary.json and comparison_metrics.csv with log_r2 values.
"""
...
def scale_targets_train_to_linear_tensor(y_scaled: torch.Tensor) -> torch.Tensor:
    """Convert normalized targets to linear space."""
