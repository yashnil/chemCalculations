#!/usr/bin/env python3
"""
generate_missing_datasets.py
=============================

Generate missing datasets (320K and 800K) for the complete retraining pipeline.
"""
...
# Missing dataset sizes to generate
MISSING_DATASETS = {
    "x320": 320000,
    "x800": 800000,
}
...
def generate_dataset(tag: str, total_samples: int):
    ...
    if fastchem_logk and fastchem_cond:
        print(f"\n📊 Step 2: Running FastChem on all shards...")
        print(f"   This will take 2-4 hours per dataset...")
        ...
        print(f"   Set FASTCHEM_LOGK and FASTCHEM_COND environment variables")
...
def main():
    print("="*80)
    print("GENERATE MISSING DATASETS (320K, 800K)")
    print("="*80)
    print("\nThis script will:")
    ...
    success_count = 0
    for tag, total_samples in MISSING_DATASETS.items():
    ...
    print("SUMMARY")
    print("="*80)
    print(f"Successfully generated: {success_count}/{len(MISSING_DATASETS)} datasets")
