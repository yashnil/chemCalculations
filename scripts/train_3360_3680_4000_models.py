#!/usr/bin/env python3
"""
train_3360_3680_4000_models.py
==============================

Train models for 3360K, 3680K, and 4000K dataset sizes using the optimal architecture.
"""
...
def main():
    print("="*80)
    print("TRAINING MODELS FOR 3360K, 3680K, AND 4000K")
    print("="*80)
    ...
    if missing:
        ...
        print("   python scripts/generate_3360_3680_4000_datasets.py")
        return
