...
# save artefacts (v9: also save T_max for inference)
joblib.dump(scaler, os.path.join(ARTE_DIR,"input_scaler.pkl"))
np.savez(os.path.join(ARTE_DIR,"splits.npz"),
         train_idx=train_idx, val_idx=val_idx, test_idx=test_idx)
joblib.dump({"T_max": T_max}, os.path.join(ARTE_DIR,"normalization_params.pkl"))
print("Scaler, split indices, and T_max saved →", ARTE_DIR)
