...
# NEW – convert back to linear fractions for metrics
EPS = 1e-12
Y_pred_lin = np.power(10.0, Y_pred) - EPS
...
mae_test = mean_absolute_error(Y_test_lin, Y_pred_lin)
r2_test  = r2_score(Y_test_lin, Y_pred_lin, multioutput="variance_weighted")
