...
def plot_species_vs_TP(df_gas, top_species, comp_index):
    ...
    for sp in top_species:
        ...
        plt.savefig(f"/Users/yashnilmohanty/Desktop/FastChem-Materials/graphs/plot_comp{comp_index}_{sp}.png", dpi=150)
        plt.close()
...
def main():
    ...
    for i, comp in enumerate(compositions):
        ...
        comp_end = time.time()
        print(f"=== Composition {i} finished in {comp_end - comp_start:.2f} seconds.")
